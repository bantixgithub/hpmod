...
public class FirstBlockScreen extends ContainerScreen<FirstBlockContainer> {
    ...
    private ResourceLocation GUI = new ResourceLocation(HpMod.MODID, "textures/gui/firstblock_gui.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        drawString(Minecraft.getInstance().fontRenderer, "Nigger", 10, 10, 0xffffff);
    }
